...
(function ($) {
	...
	this.enqueueFile = function(file){
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            var form = $("<form class='file_form' method='" + s.method + "' action='" + s.url + "' enctype='" + s.enctype + "'></form>");
            var fileInputStr = "<input type='file'  onfocus='onfocus_file(this);' title='첨부파일' onfocusout='onblur_file(this);' id='" + fileUploadId + "' name='" + s.fileName + "' accept='" + s.acceptFiles + "'/>";
            if(s.multiple) {
                if(s.fileName.indexOf("[]") != s.fileName.length - 2) // if it does not endwith
                {
                    s.fileName += "[]";
                }
                fileInputStr = "<input type='file'  onfocus='onfocus_file(this);' onfocusout='onblur_file(this);' id='" + fileUploadId + "' name='" + s.fileName + "' accept='" + s.acceptFiles + "' multiple />";
            }
