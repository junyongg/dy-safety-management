		...
		<div class="conSub01_bottomBox">
			<div class="innerContainer clearfix">
				...
				<div class="btnBox textC">
					<c:if test="${action eq 'insert' }">
					<button type="button" class="btn btn-default bg_gray_01 btnSizeM_3" onclick="pf_boardDataInsert()">글쓰기</button>
					</c:if>
					<c:if test="${action eq 'update' }">
					<button type="button" class="btn btn-default bg_gray_01 btnSizeM_3" onclick="pf_boardDataUpdate()">수정</button>
					</c:if>
					<button type="button" class="btn btn-default btnWhiteLine btnSizeM_3" onclick="pf_back()">취소</button>
				</div>
				</form:form>
