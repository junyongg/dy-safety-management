...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="txt" colspan="3">
                                    	<input type="hidden" id="THC_USERKEY" name="THC_USERKEY" value="${Hire.TH_KEYNO }">
                                        <input type="text" class="txt_pri w32" id="THC_NAME" name="THC_NAME" placeholder="한글" value="${Hire.TH_USER }" readonly="readonly">
                                        <input type="text" class="txt_pri w32" id="THC_CNAME" name="THC_CNAME" placeholder="한문" value="${Hire.THC_CNAME }">
                                        <input type="text" class="txt_pri w32" id="THC_ENAME" name="THC_ENAME" placeholder="영문" value="${Hire.THC_ENAME }">
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table class="tbl_in_01">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="3"><label><input type="text" name="THC_BOHUN" "${empty Hire.THC_BOHUN?'readonly':''}" value="${Hire.THC_BOHUN }"></label></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td><input type="text" id="n001" name="THC_DISABLED" ${empty Hire.THC_DISABLED?'readonly':''}" value="${Hire.THC_DISABLED }"></td>
                                                    <td><input type="text" id="n002" name="THC_DISABLED1" "${empty Hire.THC_DISABLED?'readonly':''}" value="${Hire.THC_DISABLED1 }"></td>
                                                    <td><input type="text" id="n003" name="THC_DISABLED2" "${empty Hire.THC_DISABLED?'readonly':''}" value="${Hire.THC_DISABLED2 }"></td>
                                                </tr>
                                            </tbody>
	...
	<!--                                         <button type="button" class="btn_pri purple calen" style="margin-left: -5px;" title="캘린더"><img src="/resources/img/sub/icon_join_calendar.png" alt=""></button> -->
					...
					<div class="employ_txtarea_box">
						...
						<textarea name="THC_OTHERDO" rows="7" class="txtarea_emply">${Hire.THC_OTHERDO}</textarea>
					</div>
				...
				<div class="employ_tab2_ul_con two"> <!-- 자기소개 -->
					...
					<div class="employ_txtarea_box">
						...
						<textarea name="THC_CONTENT1" rows="7" class="txtarea_emply">${Hire.THC_CONTENT1}</textarea>
					</div>
					...
					<div class="employ_txtarea_box">
						...
						<textarea name="THC_CONTENT2" rows="7" class="txtarea_emply" >${Hire.THC_CONTENT2}</textarea>
					</div>
					...
					<div class="employ_txtarea_box">
						...
						<textarea name="THC_CONTENT3" rows="7" class="txtarea_emply">${Hire.THC_CONTENT3}</textarea>
					</div>
					...
					<div class="employ_txtarea_box">
						...
						<textarea name="THC_CONTENT4" rows="7" class="txtarea_emply">${Hire.THC_CONTENT4}</textarea>
					</div>
				...
				<div class="employ_tab2_ul_con three"> <!-- 직무수행계획소 -->
					...
					<div class="employ_txtarea_box">
						...
						<textarea name="THC_UNYOUNG1" rows="7" class="txtarea_emply">${Hire.THC_UNYOUNG1}</textarea>
					</div>
					...
					<div class="employ_txtarea_box">
						...
						<textarea name="THC_UNYOUNG2" rows="7" class="txtarea_emply">${Hire.THC_UNYOUNG2}</textarea>
					</div>
					...
					<div class="employ_txtarea_box">
						...
						<textarea name="THC_UNYOUNG3" rows="7" class="txtarea_emply">${Hire.THC_UNYOUNG3}</textarea>
					</div>
					...
					<div class="employ_txtarea_box">
						...
						<textarea name="THC_UNYOUNG4" rows="7" class="txtarea_emply">${Hire.THC_UNYOUNG4}</textarea>
					</div>
