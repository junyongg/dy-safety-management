...
<script type="text/javascript">
	...
	function pf_AddColumn() {
		...
		html += "<input type='text' id='BL_COLUMN_LEVEL"
				+ divID
				+ "' name='BL_COLUMN_LEVEL' placeholder='정렬순서'  maxlength='50' value='' readonly='readonly' onkeydown='return cf_only_Num(event);'/>";
		html += "</label>";
		html += "</section>";
		html += "<section class='col col-3'>";
		html += "<label class='input'> <i class='icon-prepend fa fa-edit'></i>";
		html += "<input class='checkTrim' type='text' id='BL_COLUMN_NAME' name='BL_COLUMN_NAME' placeholder='컬럼명'  maxlength='50' value=''/>";
		html += "</label>";
		html += "</section>";
		html += "<section class='col col-1'>";
	...
	function pf_ajaxData(result) {
		...
		html += "<section class='col col-3'>";
		html += "<label class='input'> <i class='icon-prepend fa fa-edit'></i>";
		html += "<input class='checkTrim' type='text' id='BL_COLUMN_NAME' name='BL_COLUMN_NAME' placeholder='컬럼명'  maxlength='50' value='"+result.BL_COLUMN_NAME+"'/>";
		html += "</label>";
		html += "</section>";
		html += "<section class='col col-1'>";
		html += "<label class='select'>";
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-table fa-fw "></i> 게시판관리 <span>> 게시판 타입 수정 </span>
				</h1>
			</div>
		</div>
						...
						<div>
							<div class="widget-body-toolbar bg-color-white">
								<div class="alert alert-info no-margin fade in">
									...
									새로운 게시판 타입 정보를 수정합니다.<br> <span style="color: red;">*모든항목이
										필수 입력 항목입니다.</span>
								</div>
							</div>
