					...
					<div class="widget-body-toolbar bg-color-white">
						...
						<div class="table-responsive">
							<jsp:include page="/WEB-INF/jsp/txap/include/search/pra_search_header_paging.jsp" flush="true">
								<jsp:param value="/txap/map/sub/pagingAjax.do" name="pagingDataUrl" />
...
function pf_actionViewPage(key){
	key = key || '';
	$('#key').val(key);
	$('#Form').attr('action','/txap/map/mapSub.do?${_csrf.parameterName}=${_csrf.token}');
	$('#Form').submit();
}
