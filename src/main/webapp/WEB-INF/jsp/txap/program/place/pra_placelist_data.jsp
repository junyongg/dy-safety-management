			...
			<tr>
				...
				<td>
					<c:if test="${not empty model.FS_KEYNO }">
						<a href="/resources/img/upload/${model.FS_FOLDER }${model.FS_CHANGENM }.${model.FS_EXT }" target="_blank">
							<img src="/resources/img/upload/${model.FS_FOLDER }${model.FS_CHANGENM }_thumbnail.${model.FS_EXT }" alt="${model.FS_ORINM }" style="width:150px;">
						</a>
					</c:if>
				</td>
			</tr>
