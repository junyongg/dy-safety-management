							...
							<section class="col col-12 em_time_wrap" id="em_time_wrap" style="margin: 0px;" >
								...
								<div class="col col-12" style="padding:10px 0 10px 0;">
									<div class="col col-6" style="padding-left: 0;">
										...
										<i class="icon-prepend fa fa-edit"></i><input id="changeCnt" class="NumberOnly changeCnt" type="text" placeholder="변경할 인원수를 입력하세요." onKeyDown="return cf_only_Num(event);" maxlength="5"/>
										</label>
									</div>
									<div class="col col-6">
										<label class="input" name="" class="">
