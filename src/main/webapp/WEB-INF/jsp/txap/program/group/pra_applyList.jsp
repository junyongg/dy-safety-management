				...
				<div>
					...
					<div class="table-responsive">
						<jsp:include page="/WEB-INF/jsp/txap/include/search/pra_search_header_paging.jsp" flush="true">
							<jsp:param value="/txap/program/group/apply/pagingAjax.do" name="pagingDataUrl" />
							<jsp:param value="/txap/program/group/apply/excelAjax.do" name="excelDataUrl" />
						</jsp:include>
...
function pf_detail(key, type){
	$("#key").val(key);
	if(type == 'P'){
		$("#Form").attr("action", "/txap/program/group/applyDetail.do");
	}else if(type == 'M'){
