						...
						<form:form id="Form" name="Form" method="post" class="form-horizontal bv-form" novalidate="novalidate" enctype="multipart/form-data"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
							...
							<legend>배너 등록</legend>
								<fieldset>
									...
									<div class="form-group has-feedback">
										<label class="col-md-1 control-label"><span class="nessSpan">*</span> 링크 URL</label>
										<div class="col-md-6">
							...
							<fieldset class="padding-10 text-right"> 
								...
								<button class="btn btn-sm btn-default" id="Board_Delete" type="button" onclick="location.href='/txap/operation/banner.do'"> 
...
function pf_BannerUpdate(){
	...
	if(status){
		$("#Form").attr("action", "/txap/operation/banner/update.do?${_csrf.parameterName}=${_csrf.token}");
		$("#Form").submit();
	}
}
