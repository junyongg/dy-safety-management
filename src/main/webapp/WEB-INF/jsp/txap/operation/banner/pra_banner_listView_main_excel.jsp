...
String fileName = "사용중인 배너 리스트.xls";
...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">사용중인 배너 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	...
	<tbody>
		...
		<tr>
			<td class="tdName">${model.BM_LEVEL }</td>
			<td class="tdName">${model.BM_MN_MAINNAME }</td>
			<td class="tdName">${model.BM_TYPENAME }</td>
			<td class="tdName">${model.BM_TITLE }</td>
			<td class="tdName">${model.BM_URL }</td>
			<td class="tdName">${model.BM_REGDT }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
