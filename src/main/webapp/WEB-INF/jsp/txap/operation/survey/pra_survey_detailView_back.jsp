					...
					<div class="jarviswidget jarviswidget-color-blueDark" id="" data-widget-editbutton="false"> 
						...
						<div class="widget-body no-padding smart-form">
								<fieldset>
									...
									<div class="row"> 
										<section class="col col-12">
											<label class="col-md-1 control-label"><span class="nessSpan">*</span> 설문 제목</label>
											<div class="col-md-11">
										...
										<section class="col col-12">
											<label class="col-md-1 control-label"><span class="nessSpan">*</span> 설문 시작일</label>
											<div class="input-group">
												<input name="SM_STARTDT" id="SM_STARTDT" type="text" class="form-control datepicker" data-dateformat="yy-mm-dd" value="${SmDTO.SM_STARTDT }" maxlength="10" style="padding-left: 10px;">
												<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											</div>
										</section>
										<section class="col col-12">
											<label class="col-md-1 control-label"><span class="nessSpan">*</span> 설문 종료일</label>
											<div class="input-group">
												<input name="SM_ENDDT" id="SM_ENDDT" type="text" class="form-control datepicker" data-dateformat="yy-mm-dd" value="${SmDTO.SM_ENDDT }" maxlength="10" style="padding-left: 10px;">
												<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											</div>
										</section>
										<section class="col col-12">
										...
										<section class="col col-12">
											<label class="col-md-1 control-label">실명 사용여부</label>
										...
										<section class="col col-12">
											<label class="col-md-1 control-label">보기배점방식</label>
											<div class="col-sm-12 col-md-6">
												<label class="radio radio-inline no-margin">
...
<%-- 													 		<option value="C" <c:if test="${sq.SQ_ST_TYPE =='C' }">selected</c:if>>객관식(체크박스)</option> --%>
														</select>
														<i></i>
														</label>
													</section>
