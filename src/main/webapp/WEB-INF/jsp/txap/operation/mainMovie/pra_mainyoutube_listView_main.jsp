...
<form:form id="Form1" method="post" action="">
	...
	<input type="hidden" name="pagingUrl" value="/txap/operation/mainYoutube/pagingAjax.do">
	<input type="hidden" name="excelUrl" value="/txap/operation/mainYoutube/excelAjax.do">
	<input type="hidden" name="BM_USE_YN" value="Y">
							...
							<div class="widget-body-toolbar bg-color-white">
								<div class="row"> 
									<div class="col-sm-12 col-md-2 text-align-right" style="float:right;">
										<div class="btn-group">  
											<button class="btn btn-sm btn-primary" type="button" onclick="pf_bannerRegist()">
