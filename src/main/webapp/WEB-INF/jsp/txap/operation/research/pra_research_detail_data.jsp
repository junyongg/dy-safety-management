...
<table id="dt_basic" class="pagingTable table table-striped table-bordered table-hover" width="100%">
	<thead>
		...
		<tr>
			...
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="4" placeholder="코멘트 검색" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="5" placeholder="평가일 검색" />
			</th>
		</tr>
		<%-- 화살표 정렬 --%>
		<tr>
			<th class="arrow" data-index="1">번호</th>
			<th class="arrow" data-index="2">만족도</th>
			<th class="arrow" data-index="3">IP</th>
			<th class="arrow" data-index="4" style="width:50%;">코멘트</th>
			<th class="arrow" data-index="5">평가일</th>
		</tr>
	</thead>
	<tbody>
		<c:if test="${empty resultList }">
		...
		<tr>
			...
			<td>${model.TPS_IP }</td>
			<td style="text-align:left;"><pre><c:out value="${model.TPS_COMMENT }" escapeXml="false"/></pre></td>
