...
<table class="pagingTable table table-striped table-bordered table-hover" width="100%">
	...
	<tbody>
		...
		<tr>
			...
			<td>${model.MM_URL }</td>
			<td>${model.MM_REGNM }</td>
			<td>
				<a class="btn btn-primary btn-xs" href="#" onclick="pf_useSlide('${model.MM_KEYNO}','${model.MM_MN_KEYNO }','${model.MM_LOCATION }','Y')">
					<i class="fa fa-repeat"></i> 복원
				</a>
				<a class="btn btn-danger btn-xs" href="#" onclick="pf_DeleteSlide('${model.MM_KEYNO}')">
