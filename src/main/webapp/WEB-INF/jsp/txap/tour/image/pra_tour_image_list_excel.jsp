...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">관광사진 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">사진파일 이름</th>
			<th class="thsize">관광정보 구분</th>
			<th class="thsize">관광정보 이름</th>
			<th class="thsize">관광정보 사용여부</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="tdName">${model.FS_ORINM }</td>
			<td class="tdName">${model.TC_TYPE_NAME }</td>
			<td class="tdName">${model.TC_TITLE }</td>
			<td class="tdName">${model.TC_USE }</td>
			<td class="tdName">${model.UI_ID }</td>
			<td class="tdName">${model.REGDT }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
