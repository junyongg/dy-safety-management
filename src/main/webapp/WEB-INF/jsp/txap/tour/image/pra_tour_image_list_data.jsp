...
<table id="dt_basic" class="pagingTable table table-striped table-bordered table-hover" width="100%">
	<thead>
		...
		<tr>
			...
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="2" placeholder="사진파일 이름 검색" />
			</th>
			<th class="hasinput">
				<select class="form-control search-control" data-searchindex="3" style="width:100%;">
		            <option value="">전체</option>
		            <c:forEach items="${tourInfoList }" var="tourInfo">
						<option value="${tourInfo.SC_CODENM }">${tourInfo.SC_CODENM }</option>
					</c:forEach>
		         </select>
			</th>
			
			<th class="hasinput">
				<input type="text" class="form-control search-control" data-searchindex="4" placeholder="관광정보 이름 검색" />
			</th>
			<th class="hasinput">
		...
		<tr>
			...
			<th class="arrow" data-index="2" style="width:20%;" >사진파일 이름</th>
			<th class="arrow" data-index="3">관광정보 구분</th>
			<th class="arrow" data-index="4">관광정보 이름</th>
			<th class="arrow" data-index="5">관광정보 사용여부</th>
	...
	<tbody>
		...
		<tr>
			<td>${model.COUNT}</td>
			<td>
				<a href="javascript:;" onclick="pf_viewImage('${model.FS_PATH}')">${model.FS_ORINM}</a>
			</td>
