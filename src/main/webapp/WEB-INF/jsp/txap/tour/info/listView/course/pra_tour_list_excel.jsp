...
<table>
	<thead>
		<tr></tr>
		<tr class="background">
			<th colspan="${colspan}" class="title">코스 리스트</th>
		</tr>
		<tr></tr>
		<tr>
...
<table id="dt_basic">
	<thead>
		<tr class="background2">
			...
			<th class="thsize">관람소요시간</th>
			<th class="thsize">추천수</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="tdName">${model.TCM_TYPE_NAME }</td>
			<td class="tdName">${model.TC_TITLE }</td>
			<td class="tdName">${model.TCM_TIME }</td>
			<td class="tdName">${model.TC_UP_CNT }</td>
			<td class="tdName">${model.TC_USE }</td>
			<td class="tdName">${model.UI_ID }</td>
			<td class="tdName">${model.TC_REGDT }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
