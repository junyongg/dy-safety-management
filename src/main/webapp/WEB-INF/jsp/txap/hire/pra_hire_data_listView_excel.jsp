...
<table id="dt_basic">
	...
	<tbody>
		...
		<tr>
			<td class="tdName">${model.TH_NUMBER }</td>
			<td class="tdName">${model.TH_USER }</td>
			<td class="tdName">${model.TH_PHONE }</td>
			<td class="tdName">${model.TH_EMAIL }</td>
			<td class="tdName">${model.TH_TYPE eq 'U'?'운영직':'기간제'}</td>
			<td class="tdName">${model.TH_PASS_YN eq 'Y'? '합격':'불합격' }</td>
		</tr>
		</c:forEach>
	</tbody>
</table>
