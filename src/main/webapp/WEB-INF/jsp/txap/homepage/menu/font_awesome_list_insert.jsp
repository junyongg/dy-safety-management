...
$(function(){
	...
	$('#menuIconBox_insert .demo-icon-font').on('click', function(){
	  $('#menuIconBox_insert .demo-icon-font').removeClass('selectedIcon');
	  $(this).addClass('selectedIcon');
// 	  alert($(this).children('i').attr('class'));
	  var classNm = $(this).children('i').attr('class');
	  $('#menuIconView_insert').attr('class','').addClass(classNm);
	  $('#Mainmenu-insert-ICONBOX').val(classNm);
