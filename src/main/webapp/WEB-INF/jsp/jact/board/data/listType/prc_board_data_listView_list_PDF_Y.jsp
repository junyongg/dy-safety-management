...
<!-- 					<li style="font-size: 26px;"><a href="/jact/archives/picture.do" style="font-size: 13px;">동영상 서비스</a></li> -->
					...
					<li class="active"  style="font-size: 26px;"><a href="/jact/archives/reference.do" style="font-size: 13px;">카드뉴스</a></li>
			...
			<c:forEach items="${BoardNoticeDataList }" var="model" varStatus="status">
				...
				<!-- 썸네일 -->
					<div class="in">
						<div class="img-b">
							<c:if test="${model.THUMBNAIL_PATH ne null}">
								<a href="javascript:;" style="font-size: 31px;" onclick="${detailFunction}"><img src="/resources/img/upload/${model.THUMBNAIL_PATH }" alt="이미지"></a>
							</c:if>
						</div>
					<div class="letter-b">
					<a href="javascript:;" style="font-size: 31px;" onclick="${detailFunction}">
					 ...
					 <c:if  test="${not empty model.BN_FM_KEYNO }">
