...
<form:form id="Form" name="Form" method="post">
		...
		<div style="margin-left: 400px; margin-top: 20px;">
			<table class="tg" style="width: 80%; border: 3px solid black;">
				...
				<tbody>
					...
					<tr>
						<td class="tg-0lax" colspan="24">누적 발전량 <select
					...
					<tr class="border">
						<td class="tg-0lax" colspan="24">기간 발전량<select
				...
				<tr>
					...
					<td class="tg-0lax" colspan="6">L1 - N</td>
					<td class="tg-0lax" colspan="12"><label id="sa2_label5">
					...
					<td class="tg-0lax" colspan="6">L1</td>
					<td class="tg-0lax" colspan="12"><label id="sa2_label6">
							<input type="text" style="width: 100%"
							class="tb_gbla1 input_type_serch"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
							onclick="jun()"
				...
				<tr>
					<td class="tg-0lax" colspan="6">L2 - N</td>
					<td class="tg-0lax" colspan="12"><label id="sa2_label7">
							<input type="text" style="width: 100%"
							class="tb_gbla1 input_type_serch"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
							onclick="jun()"
					...
					<td class="tg-0lax" colspan="6">L2</td>
					<td class="tg-0lax" colspan="12"><label id="sa2_label8">
							<input type="text" style="width: 100%"
							class="tb_gbla1 input_type_serch"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
							onclick="jun()"
				...
				<tr class="border">
					<td class="tg-0lax" colspan="6">L3 - N</td>
					<td class="tg-0lax" colspan="12"><label id="sa2_label9">
							<input type="text" style="width: 100%"
							class="tb_gbla1 input_type_serch"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
							onclick="jun()"
					...
					<td class="tg-0lax" colspan="6">L3</td>
					<td class="tg-0lax" colspan="12"><label id="sa2_label10">
							<input type="text" style="width: 100%"
							class="tb_gbla1 input_type_serch"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
							onclick="jun()"
				...
				<tr>
					...
					<td class="tg-0lax" colspan="12"><label> <input
							type="text" style="width: 100%" class="tb_gbla1 input_type_serch"
							value="${now}" name="sa2_date2" id="sa2_date2">
					</label></td>
				</tr>
				<tr>
					<td class="tg-0lax" colspan="24">전월 누적 송전 유효전력량[KWh]-전체</td>
					<td class="tg-0lax" colspan="6"><select id="sa2_meternum1"
						name="sa2_meternum1" onchange="changenumber(this.value)">
							<option value="">계량기선택</option>
							<option value="4">계량기#4</option>
							<option value="5">계량기#5</option>
					</select></td>
					<td class="tg-0lax" colspan="9"><label> <input
							type="text" style="width: 100%" class="tb_gbla1 input_type_serch"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
				...
				<tr class="border">
					<td class="tg-0lax" colspan="24">현재 누적 송전 유효전력량[KWh]-전체</td>
					<td class="tg-0lax" colspan="6"><select id="sa2_meternum2"
						name="sa2_meternum2">
							<option value="">계량기선택</option>
	...
	<div id="prepaper"></div>
>>>>>>> 63e32b769f0633a80460cf62c9db047627d9e90b
</form:form>
...
function changesulbi(keyno) {
	...
	$.ajax({
        ...
        success: function(result) {
        	...
        	console.log(result.data.SU_SA_RG);
        	...
        	$("#sa2_nowpower").val("164")
        	$("#sa2_todaypower").val("2607")
        	$("#sa2_accpower").val("665,260")
