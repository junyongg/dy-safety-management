			...
			<div id="sub-con-start">
				...
				<div class="tab-in-box">
					<ul class="tab_ul tab-2">
						<li id="tab1" class="active" ><a href='javascript:;'   onclick="setTap(1)">지역문화 특성화지원</a></li>
						<li id="tab2" ><a href='javascript:;' onclick="setTap(2)">공연장상주단체지원</a></li>
					</ul>
				</div>
				...
				<div id="li1" class="sub-business-content">
					...
					<div class="img-box">
						<img src="/resources/img/sub/img_s_busi_01_01.jpg" alt="이미지">
					</div>
					...
					<div class="contents pdMore">
						...
						<div class="one"> <!-- one -->
							...
							<div class="in">
								<p class="p-con">
									(전통예술) 전남의 전통문화를 소재로 하는 문화예술 활동(전통문화 보존, 육성, 창작 등) <br>
									(시각·공연예술·문학) 단체(개인)의 시각·공연예술 및 문학활동 지원 <br>
									(문화예술연구) 전통문화예술 연구조사, 비평, 포럼 세미나 지원 등
								</p>
							</div>
						</div> <!-- one END -->
						...
						<div class="one"> <!-- one -->
							...
							<div class="in">
								<p class="p-con">
									국외 또는 도내에서 진행되는 해외 국가(해외)와의 교류공연 및 교류전시 등
								</p>
							</div>
						</div> <!-- one END -->
						
						<div class="one"> <!-- one -->
							<p class="title-num"><b>03</b> 공연예술 작품 제작 지원사업</p>
							<div class="in">
								<p class="p-con">
									지역의 역사·문화자원등을 활용한 창작공연 제작 발표
									단체의 초연창작 작품(기존 작품 각색하여 공연되는 작품도 인정) 제작 및 발표
								</p>
							</div>
						</div> <!-- one END -->
						
						<div class="one"> <!-- one -->
							<p class="title-num"><b>04</b> 공연예술 작품 제작 지원사업</p>
							<div class="in">
								<p class="p-con">
									창작, 소통, 향유 시스템을 통한 예술가 레지던스 프로그램 운영
									지역 신진예술가 발굴, 육성 및 교류 지원사업
								</p>
							</div>
						</div> <!-- one END -->
						
						<div class="one"> <!-- one -->
							<p class="title-num"><b>05</b> 지역문화예술육성지원사업</p>
							<div class="in">
								<p class="p-con">
									남도문예르네상스 비교우위자원을 소재로 하는 기획 사업을 발굴하여 전남만의 특화된 브랜드 개발
								</p>
						...
						<div class="one"> <!-- one -->
							<p class="title-num"><b>06</b> 청년예술가 활동 지원사업</p>
							<div class="in">
								<p class="p-con">
									(청년 예술가의 창작 문화예술 활동
								</p>
						...
						<div class="one"> <!-- one -->
							<p class="title-num"><b>07</b> 주민밀착형 문화예술 지원사업</p>
							<div class="in">
								<p class="p-con">
									장르, 지역 구분없이 주민밀착형, 주민주도형 사업활동 지
								</p>
							</div>
						</div> <!-- one END -->
				...
				<div id="li2" class="sub-business-content" style="display: none;">
					...
					<div class="img-box">
						<img src="/resources/img/sub/img_s_busi_01_02.jpg" alt="이미지">
					</div>
