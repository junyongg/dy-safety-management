...
<section id="sub-content">
	<div class="inner1200">
		...
		<div class="tab-in-box">
			<c:if test="${currentMenu.MN_MAINKEY eq 'MN_0000001598' }">
				<ul class="tab_ul tab-5">
					...
					<li class="tab22 active"><a href="/culture/business/mahayungu.do">마한 연구동향</a></li>
		...
		<div class="sub-con-start">
			<div class="tab-in-box">
				<ul class="tab_ul tab-3">
					<li class="active"><a href="/jact/data/gongsi/budgetmg.do">업무추진비 사용내역</a></li>
					<li><a href="/jact/data/gongsi/cost.do">복리후생비 사용내역</a></li>
					<li><a href="/jact/data/gongsi/sign.do">조달계약실적</a></li>
				</ul>
			</div>
		</div>
			...
			<div class="sub-con-start">
				<div class="tab-in-box">
					<ul class="tab_ul tab-3">
						...
						<li class="active"><a href="/jact/data/gongsi/cost.do">복리후생비 사용내역</a></li>
						<li><a href="/jact/data/gongsi/sign.do">조달계약실적</a></li>
					</ul>
				</div>
			</div>
		...
		<c:if test="${currentMenu.MN_KEYNO eq 'MN_0000001592' }">
			<!-- 탭부분 -->
				<div class="tab-in-box">
					<ul class="tab_ul tab-4">
						<li class="tab1"><a href="/culture/refer/report.do">학술보고서</a></li>
						<li class="tab2"><a href="/culture/refer/semina.do">학술세미나</a></li>
						<li class="tab3"><a href="/culture/refer/paper.do">학술논문집</a></li>
						<li class="tab4 active"><a href="/culture/refer/cul.do">무형문화재</a></li>
					</ul>
				</div>
		</c:if>
...
<!-- 일반유저 자유게시판 작성가능하게  -->
			<c:if test="${userInfo.isAdmin eq 'N' && currentMenu.MN_MAINKEY eq 'MN_0000001574' }">
				<div class="bor-btn-b">
					<button type="button" class="btn-write" onclick="pf_RegistMove()">글쓰기</button>
				</div>
			</c:if>
