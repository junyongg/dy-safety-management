								...
								<div class="board-write-box">
									...
									<div class="table-box">
										<table class="tbl_write_1">
											...
											<tr style="border-top: 1px solid #6a3b81;">
												<th><label>동영상 입력 방법</label></th>
												<td>
													<div>
														<label> <input type="radio" name="linkinsert" id="linkinsert1" value="Y" checked> 유튜브 링크 </label>
														<label> <input type="radio" name="linkinsert" id="linkinsert2" value="N"> 파일로 등록 </label>
													</div>
												</td>
											</tr>
											...
											<c:forEach items="${BoardColumnList }" var="model"
												varStatus="status">
												<input type="hidden" name="BD_BL_TYPE"
													value="${model.BL_TYPE }">
												<input type="hidden" name="BD_BL_KEYNO"
													value="${model.BL_KEYNO }">
												<input type="hidden" id="BD_KEYNO${model.BL_KEYNO }"
													name="BD_KEYNO" value="공고중|종료&결과">
												...
												<c:if test="${checkTitle && BoardType.BT_THUMBNAIL_YN eq 'Y' }">
													...
													<tr id="Thumbnail">
														...
														<td><img style="width:${BoardType.BT_THUMBNAIL_WIDTH }px;height:${BoardType.BT_THUMBNAIL_HEIGHT }px;margin:5px 0;" onerror="this.style.display='none';" src="/resources/img/upload/${BoardNotice.THUMBNAIL_PATH }"
															id="thumbnail_img" alt="썸네일" />
															<div class="clear"></div> <input type="file"
															id="thumbnail" name="thumbnail"
															class="txtDefault txtWlong_1" onchange="cf_imgCheckAndPreview('thumbnail')"> <img	src="/resources/img/icon/icon_attachment_01.png" alt="링크">
												...
												<c:if test="${model.BL_TYPE eq BOARD_COLUMN_TYPE_TEXT }">
													<tr id="youtubelink">
														...
														<td><input type="text" class="${BL_VALIDATE} txtDefault txtWlong_1" data-title="${model.BL_COLUMN_NAME }" id="BD_DATA${model.BL_KEYNO }" name="BD_DATA" value="" maxlength="70">
														</td>
													</tr>
												</c:if>
											...
											<c:if
												test="${BoardType.BT_UPLOAD_YN == 'Y'  && not empty userInfo}">
												<tr id="filechum">
													<th><label>첨부파일</label></th>
													<td>
													<p style="color:#f54a4a">*IE에서 키보드로 접근시 스페이스바를 누르면 파일을 선택 창이 나타납니다</p><br>
											...
											<tr>
												...
												* 글쓰기 창 포커싱에서 이전 요소로 포커싱을 옮기려면 alt+" , "을 다음 요소로 포커싱을 옮기려면 alt+" . "을 눌러주세요.<br></p>
												...
												<c:if test="${action eq 'insert' }">
													...
													<c:if test="${action eq 'update' || action eq 'move'}">
														<textarea name="BN_CONTENTS" id="BN_CONTENTS" rows="5"
															style="width: 100%; height: 400px; min-width: 260px;border: 1px solid #cfcfcf;"" 
