...
public class CommonServiceImpl extends EgovAbstractServiceImpl implements CommonService {
	...
	public String getTableName(String TableCode){
		...
		switch (TableCode) {
			 ...
			 case "AP" 	 	: TableName = "T_APPLICAITON_MANAGER"; break;		 	// 신청 관리 테이블
			 case "APD" 	: TableName = "T_APPLY_PARTICIPATE_DISCOUNT"; break; 	// 신청 관리 테이블(요금제)
			 case "APC" 	: TableName = "T_APPLICATION_CHARGE"; break;		 	// 신청 프로그램 요금관리 테이블
			 case "APP" 	: TableName = "T_APPLICATION_PARTICIPATE"; break;	 	// 신청 프로그램 참가인원 관리 테이블
			 case "ASM" 	: TableName = "T_APPLICATION_SCHEDULE_MAIN"; break;	 	// 신청 프로그램 스케쥴 관리 메인 테이블
			 case "ASS" 	: TableName = "T_APPLICATION_SCHEDULE_SUB"; break;	 	// 신청 프로그램 스케쥴 관리 서브 테이블
			 case "AD" 		: TableName = "T_APPLICATION_DISCOUNT"; break;	 	 	// 신청 프로그램 할인정책 관리 서브 테이블
			 case "APU" 	: TableName = "T_APPLICATION_USER"; break;			 	// 프로그램 신청 수강대상자 관리 테이블
			 case "GM" 		: TableName = "T_GROUP_MANAGER"; break;			 	 	// 단체프로그램 신청관리 테이블
			 case "GP" 		: TableName = "T_GROUP_PARTICIPATE"; break;			 	// 단체관람 관리 테이블
			 case "GSM" 	: TableName = "T_GROUP_SCHEDULE_MAIN"; break;		 	// 단체관람 스케줄 관리 메인 테이블
			 case "GSS" 	: TableName = "T_GROUP_SCHEDULE_SUB"; break;		 	// 단체관람 스케줄 관리 서브 테이블
			 ...
			 case "SM"	 	: TableName = "T_SURVEY_MGR"; break;					// 설문지 관리
			 case "SQ"	 	: TableName = "T_SURVEY_QUESTION"; break;				// 설문지 문항
			 case "SQO"	 	: TableName = "T_SURVEY_QUESTION_OPTION"; break;		// 설문지 문항 보기
			 case "SRM"	 	: TableName = "T_SURVEY_RESULT_MGR"; break;				// 설문 결과 관리
			 case "SRD"	 	: TableName = "T_SURVEY_RESULT_DATA"; break;			// 설문 결과 데이터
