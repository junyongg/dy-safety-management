...
public class safeUserDTO {
	...
	public void setSU_KEYNO(String sU_KEYNO) {
		SU_KEYNO = sU_KEYNO;
	}
	public String getSU_SA_SULBI() {
		return SU_SA_SULBI;
	}
	...
	public void setSU_SA_KAKAOYN(String sU_SA_KAKAOYN) {
		SU_SA_KAKAOYN = sU_SA_KAKAOYN;
	}
	public String getSU_SA_MSGYN() {
		return SU_SA_MSGYN;
	}
